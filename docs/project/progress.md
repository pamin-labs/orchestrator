...
- Tests: 850 pass, 15 environment skips, 0 fail across 104 files
...
- Full suite reached 850 pass and 0 fail. Six OpenSandbox tests are gated on a
...
- Fallow's default new-only audit is green. `bun run audit:all` remains red on
  27 inherited complexity/CRAP findings; they are not hidden by a saved baseline,
